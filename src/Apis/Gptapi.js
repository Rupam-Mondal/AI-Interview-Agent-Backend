    ...
    const response = await client.path("/chat/completions").post({
        body: {
            ...
            messages: [
                ...
                {
                    role: "user",
                    content: `Generate 5 interview questions for ${topic} at ${experience} level, do not write extra sentence`
                }
            ]
        }
    });
    ...
    const response = await client.path("/chat/completions").post({
        body: {
            ...
            messages: [
                ...
                {
                    role: "user",
                    content: `${Question} in short. and never reveal that you are chatgpt. You are made by Mockmate ai team. If the questions is not related to Interview just reply ask interview related question`
                }
            ]
        }
    });
